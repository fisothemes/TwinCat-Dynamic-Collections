...
.. list-table::
   ...
   * - Name
     ...
     - Description
   * - ``pNode``
     - ``REFERENCE TO POINTER TO`` :ref:`T_Hashset_Bucket_Node <t_hashset_bucket_node>`
     -


.. _fb_hash_set.fb_exit:
