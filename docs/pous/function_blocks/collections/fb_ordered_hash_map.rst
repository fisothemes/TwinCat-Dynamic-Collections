.. _fb_ordered_hash_map:

FB_Ordered_Hash_Map (Function Block)
====================================

A collection that stores key-value pairs while preserving their insertion order.
...
.. _fb_ordered_hash_map._bucket_count:
...
.. _fb_ordered_hash_map.create_buckets:
...
.. _fb_ordered_hash_map.create_node:
...
.. _fb_ordered_hash_map.delete_node:
...
.. list-table::
   ...
   * - Name
     ...
     - Description
   * - ``pNode``
     - ``REFERENCE TO POINTER TO`` :ref:`ST_ORDERED_HASHMAP_BUCKET_NODE <st_ordered_hashmap_bucket_node>`
     -


.. _fb_ordered_hash_map.fb_exit:
...
.. _fb_ordered_hash_map.get_as_string:
...
.. _fb_ordered_hash_map.get_generic:
...
.. _fb_ordered_hash_map.get_values:
...
.. _fb_ordered_hash_map.insert_generic:
...
.. _fb_ordered_hash_map.remove_generic:
...
.. _fb_ordered_hash_map.update_generic:
